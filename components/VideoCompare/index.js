...
function VideoCompare() {
  ...
  return (
      <div className="hidden laptop:block" id="video-compare-container" ref={videoContainerRef} onMouseMove={trackLocation} onMouseUp={stopDragging} onMouseLeave={stopDragging} style={{ backgroundColor: "#1B1B1B" }}>
        <video loop autoPlay muted playsinline poster="../images/after_redesign.jpg">
      ...
      >
        <video className="video-before" loop autoPlay muted playsinline poster="../images/before_redesign.jpg" ref={clippedVideoRef} style={{ backgroundColor: "#1B1B1B" }}>
