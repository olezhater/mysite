  ...
  return (
    <div className={`relative ${data.showCursor && "cursor-none"}`}>
      ...
      <div className="container mx-auto my-10 laptop:px-10">
        ...
        <img src="../img/project-4/4-1.png" className="w-full" alt="One of the top food retail chains"/>
        <img src="../img/project-4/4-2.png" className="w-full" alt="UX Challenge"/>
        <img src="../img/project-4/4-3.png" className="w-full" alt="My contributions"/>
        <img src="../img/project-4/4-4.png" className="w-full" alt="Key Customer Journey Map Areas"/>
        <img src="../img/project-4/4-5.png" className="w-full" alt="Discover and Empathize"/>
        <img src="../img/project-4/4-6.png" className="w-full" alt="Ideate and Prototype"/>
        <img src="../img/project-4/4-7.png" className="w-full" alt="User interface delivery app cart and checkout"/>
        ...
        <img src="../img/project-4/4-9.png" className="w-full" alt="Our design team utilized a new design system built with design tokens"/>
