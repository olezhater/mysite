    ...
    <div className={`relative ${data.showCursor && "cursor-none"}`}>
      ...
      <div className="container mx-auto my-10 laptop:px-10">
        ...
        <div className="pt-16 mb-8">
          ...
          <p className="text-xl my-5">Magnit Company faces the challenge of managing two applications: Magnit Sales and Discounts, and Magnit Delivery. The decision has been made to merge these two applications and integrate the delivery feature into the primary Magnit app.</p>
        </div>
        <img
          src={
            currentTheme === "light" 
        ...
        <div className="pt-16 mb-8">
          ...
          <p className="text-xl my-5">Before delving into the task, we collaborated with the business analyst to gather user feedback from App Store and Google Play reviews. Additionally, our UX researcher assisted in collecting user feedback during recent interviews. Through these efforts, we pinpointed several issues concerning the shopping cart and checkout process.</p>
        </div>
        <img
          src={
            currentTheme === "light" 
        ...
        <div className="pt-16 mb-8">
          ...
          <p className="text-xl my-5">Together with the product manager, we decided to implement the following interface changes in the application</p>
        </div>
        <img
          src={
            currentTheme === "light" 
        ...
        <div className="pt-16 mb-8">
          ...
          <p className="text-xl my-5">With the UX researcher, we conducted several user tests. Additionally, with the collaboration of the development team we launched A/B tests. Here are the insights we gained after several rounds of testing.</p>
        </div>
        <img
          src={
            currentTheme === "light" 
        ...
        <div className="pt-16 mb-8">
          ...
          <p className="text-xl my-5">By consolidating all major services in one app, we significantly enhance the shopping experience. Now, making an online order doesn&apos;t require downloading a separate app. We anticipate that the online ordering feature will be sought after by 20% of the main app users, which will significantly impact the company&apos;s profitability.</p>
        ...
        <div className="pt-16 mb-8">
          ...
          <p className="text-xl my-5">In the new update of the Magnit app, our design team utilized a new design system built with design tokens. We rebuilt all components for Magnit Express, Hyper, Cosmetics, and Pharmacy delivery services. With the introduction of variables in Figma, switching between these services in the design creation process has become even easier.</p>
        </div>
        <img
          src={
            currentTheme === "light" 
