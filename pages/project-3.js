    ...
    <div className={`relative ${data.showCursor && "cursor-none"}`}>
      ...
      <div className="container mx-auto my-10 laptop:px-10">
        ...
        <div className="pt-16 mb-8">
          ...
          <p className="text-xl my-5">The main task of the project is to create an interface for the bank&apos;s technical support service, which is responsible for installing new application releases and troubleshooting. To configure and redirect traffic between data centers (DC), you need to access the code using different applications. It&apos;s tedious and inconvenient.The new UI can switch traffic between DC&apos;s when we have an accident with one of them (when one of the DC&apos;s is offline), when we want to start beta testing, or when we want to do a smooth rollout of the new release.</p>
        </div>
        ...
        <div className="pt-16 mb-8">
          ...
          <p className="text-xl my-5">In the process of creating layouts, it was necessary to work with a large amount of data. I received content, but the architects could change it every week. I had to make changes in design layouts (it was important to get the most plausible prototypes for approval and testing). I found a great plugin for Figma - Google Sheets Sync. I made a table and sent it to the architects. So I got my own backend system for layouts.</p>
        </div>
        ...
        <img src="../img/project-3/3-6.png" className="w-full mb-8" alt="user interface"/>
        <div className="my-5">
          <img src="../img/project-3/3-7.png" className="w-full mb-8" alt="user interface"/>
        </div>
