  ...
  return (
    <div className={`relative ${data.showCursor && "cursor-none"}`}>
      ...
      <div className="container mx-auto my-10 laptop:px-10">
        ...
        <img src="../img/project-5/5-1.png" className="w-full" alt="What We Implemented and the Problems Solved"/>
        <img src="../img/project-5/5-2.png" className="w-full" alt="UI delivery app. Search field at the bottom"/>
        <img src="../img/project-5/5-3.png" className="w-full" alt="Research Scenarios and Goals"/>
        ...
        <img src="../img/project-5/5-5.png" className="w-full" alt="UX Design Research Findings"/>
