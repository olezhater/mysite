    ...
    <div className={`relative ${data.showCursor && "cursor-none"}`}>
      ...
      <div className="container mx-auto my-10 laptop:px-10">
        ...
        <div className="pt-16">
          ...
          <p className="text-xl my-5">I had to develop the design for a new feature in the bank&apos;s application. Security questions are an additional means of client identification. My task was to ensure that in the application settings, users could understand the purpose of security questions and easily configure them.</p>
        </div>
        ...
        <div className="pt-16 mb-8">
          ...
          <p className="text-xl my-5">An example of a money transfer</p>
        </div>
          <img
            src={
              currentTheme === "light" 
          ...
          />
          <div className="pt-16">
          <p className="text-xl my-5">This feature has impacted overall user satisfaction positively. With security questions in place, users feel more secure. Furthermore, as we&apos;ve implemented an additional security system, we hope it will help reduce the number of fraudulent transactions.</p>
        </div>
